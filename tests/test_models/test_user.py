...
class TestUser_instantiation(unittest.TestCase):
    """
    Unittests tests the User model class test case
    """
    ...
    def test_for_instantiation(self):
        """
        Unittests tests instantiation of User class.
        """
        user = User()
    ...
    def test_email_attr(self):
        """
        Tests that User has attr email and is empty
        """
        user = User()
    ...
    def test_password_attr(self):
        """
        Tests that User has attr password and is empty
        """
        user = User()
    ...
    def test_first_name_attr(self):
        """
        Tests that User has attr first_name and is empty
        """
        user = User()
    ...
    def test_last_name_attr(self):
        """
        Tests that User has attr last_name and is empty
        """
        user = User()
    ...
    def test_to_dict_values(self):
        """
        Assures values returned to_dict are accurate
        """
