#!/usr/bin/python3
"""File entails unittests for console.py."""
import os
import sys
import unittest
import inspect
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """
    This test tests the prompting of the HBNB command interpreter.
...
class TestHBNBCommand_help(unittest.TestCase):
    """
    This tests the help messages of the HBNB command interpreter.
    Displays intructions for specific commands
    """
...
class TestHBNBCommand_exit(unittest.TestCase):
    """
    Tests the exiting from the HBNB command interpreter.
    Exits the console
    """
...
class TestHBNBCommand_create(unittest.TestCase):
    """
    Tests the create from the HBNB command interpreter.
    Creates an object of type and prints its ID
    """
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """
    Tests the destroy command from the HBNB command interpreter.
    Deletes objects based on the class name.
    """
...
class TestHBNBCommand_all(unittest.TestCase):
    """
    Tests all of the HBNB command interpreter.
    Prints all string representations of all objects
    Prints all string representations of specific class of objects
    """
...
class TestHBNBCommand_update(unittest.TestCase):
    """
    Tests the update from the HBNB command interpreter.
    Updates an object with a certain attribute.
    """
...
class TestHBNBCommand_count(unittest.TestCase):
    """
    Tests the count method of HBNB comand interpreter.
